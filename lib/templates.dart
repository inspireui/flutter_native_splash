...
String windowsMain(int? width, int? height) {
  return '''
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  Win32Window::Point origin((unsigned int)((1280 - size.width) / 2), (unsigned int)((720 - size.height) / 3));
  if (!window.CreateAndShow(L"  FluxBuilder", origin, size)) {
    return EXIT_FAILURE;
  }
